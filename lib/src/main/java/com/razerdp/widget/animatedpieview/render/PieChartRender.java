...
public class PieChartRender extends BaseRender implements ITouchRender {
    ...
    @Override
    public boolean onPrepare() {//TODO 准备
    ...
    private void drawText(Canvas canvas, PieInfoWrapper wrapper) {
        ...
        float fixPos = (wrapper.equals(mTouchHelper.floatingWrapper) ? getFixTextPos(wrapper) : 0)
                + (wrapper.equals(mTouchHelper.lastFloatWrapper) ? getFixTextPos(wrapper) : 0);
