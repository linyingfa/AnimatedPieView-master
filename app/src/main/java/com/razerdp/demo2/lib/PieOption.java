...
public class PieOption implements Parcelable {
    ...
    Bitmap mLabelIcon;
    @com.razerdp.widget.animatedpieview.data.PieOption.LabelPosition
    ...
    public static final Parcelable.Creator<PieOption> CREATOR = new Parcelable.Creator<PieOption>() {
        @Override
    ...
    @PieOption.LabelPosition
    public int getLabelPosition() {
        return mLabelPosition;
    }

    public PieOption setLabelPosition(@com.razerdp.widget.animatedpieview.data.PieOption.LabelPosition int labelPosition) {
